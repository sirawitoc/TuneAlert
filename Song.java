...
public final class Song {
     ...
     * @param tags 
     * @throws llegalArgumentException เมื่อผิดเงื่อนไข
     */
    ...
    public boolean equals(Object obj) {
        if (this == obj) return true; // 1 เร็ว
        if (!(obj instanceof Song)) // 2 ชนิด
        return false; // (กัน null ด้วย)
        Song other = (Song) obj; // 3 cast
        return title.equals(other.title)  // 4 เทียบ
        && artist.equals(other.artist) // ทีละ field
